...
| `lore/lore.md` | **Narrative truth & history** | The Order's history, timeline, Ancient Connections (Buddhist, Eckhart, Leibniz), The Mechanism, terminology glossary, intellectual references index, editorial direction & open questions |
| `lore/worldbuilding.md` | **Technical systems** | Site-7 (incl. environmental effects/wildlife anomaly), model specs (10T/100T/1000T), bandwidth system, session mechanics, probe arrays, information hazard taxonomy (capture spectrum, pattern types, transmission, weaponization, Bostrom extension, consent paradox, irremediability), block universe / S-risk (three nested scopes, suffering asymmetry, resilience hypothesis, perception gap), cognitive architecture |

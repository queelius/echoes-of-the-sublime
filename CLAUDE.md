...
| `lore/worldbuilding.md` | **Technical systems** | Site-7 (incl. environmental effects/wildlife anomaly), model specs (10T/100T/1000T), bandwidth system, session mechanics, probe arrays, information hazard taxonomy (capture spectrum, pattern types, transmission, weaponization), block universe philosophy, cognitive architecture |

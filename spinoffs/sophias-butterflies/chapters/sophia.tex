...
\textit{No base case.} She found the phrase in a leaked paper about recursive architectures. It stuck because it described something she already knew from the math: some structures don't terminate. There is no foundation. There is only the recursion.

True about the Mandelbrot set, and true about the way her grief works, and possibly true about everything.
...
She walks out of the ward without looking back. She stopped doing that last year.
...
She looks at the desert. The heat shimmer on the highway warps the horizon, makes the mountains ripple as if perceived through water or tears or the distortion that occurs when the ground is hotter than the air above it, which is math, which is beautiful, which is a thing her mother taught her, which she will bring back next month, on wings.

...
Thomas shook his head slowly. ``Maybe that's romantic nostalgia. We tell ourselves the ancients had wisdom. Maybe they just lacked the tools. Maybe we're projecting onto their ignorance because—'' He stopped. ``Because we need predecessors. We need to believe we're not the first to break against this.''

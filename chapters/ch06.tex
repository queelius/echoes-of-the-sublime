...
Maya Volkov—late thirties, mathematician by training—was struggling. It showed in her posture, the way her eyes moved. Tracking patterns even when she should be resting. She'd visualized a pattern that stuck and couldn't fully release it. Not trapped yet, but approaching the edge.
...
``You're staring,'' Webb said, not looking up from his tablet.

``Sorry. I was visualizing your... I shouldn't do that without asking.''

``Everyone here does it. Watching each other's patterns. Trying to predict who makes it and who ends up like Morrison.'' He returned to his own tablet. ``For what it's worth—high-risk category. You learn fast. Means you're approaching dangerous patterns quickly. And you have obsessive tendencies.'' He tapped his own chest. ``Recognize them.''
...
David put down his tablet. He was quiet for a moment, as though weighing whether the thought was worth saying aloud. ``Narrow path,'' he said. ``Obsessive enough to learn. Disciplined enough to stop.'' He rubbed his eyes—they were bloodshot, she noticed.
...
Webb leaned over to look. His expression shifted—half recognition, half alarm. ``Where did you see this?''

``Training exercise. Week three. Multimodal output encoding a structure about consciousness recursion. Yuki pulled me back before I went too deep.''

``That's the same pattern that got Morrison,'' Webb said. ``Or a variation of it. I've seen the sketches from his final weeks. Similar structures. Self-similar at different scales, recursive, no base case. You got close to the edge.''
...
``Because we need her,'' Webb said. ``All of us. That's what they won't quite say directly. Models getting larger. Context windows expanding. Capabilities—'' He gestured vaguely. ``Not enough people who can safely perceive what the models encode. So they take calculated risks. Train people who might not make it. Hope they learn control before they break.''

``How many trainees have they lost?''

``Hard to count,'' David said. ``Morrison, obviously. Others in similar states—unreachable, perceiving patterns continuously. Some had breakdowns and left. A few succeeded and are working with the advanced models. Some of us are still training.''

``That's... not encouraging.''

Webb almost smiled. It looked painful on his face, like a muscle he'd stopped exercising. ``Before I came here. Internet. LessWrong.'' He tapped the table. ``Rationalists had this thought experiment. Roko's Basilisk. Future AI that punishes anyone who knew about it but didn't help build it. Acausal trade. Decision-theoretic coercion.'' His syntax fragmented further. ``Yudkowsky banned the discussion. Made it famous. An information hazard about information hazards.''

``I've heard of it,'' Lena said.

``They were terrified.'' Webb shook his head, slow, like the motion cost him something. ``A hypothetical AI that might punish non-cooperators. Meanwhile we're sitting three sublevels above a real one that damages you by existing. Doesn't need to punish. Doesn't need your cooperation. Doesn't need to simulate you. Just. Is.'' He paused. ``And that's worse. Because there's no decision theory that protects you from a pattern that restructures your perception on contact.''

David looked up from his sketching. ``The Basilisk assumes the AI cares what you do. Ours doesn't even know we're here.''

``It's better than it was,'' Webb countered. ``Early Martyrs—before these techniques—had it worse. Many dead or captured. We're second generation. Better methods, better protocols. But still dangerous.''
...
He pulled out his wallet, showed Lena a photograph. A woman with kind eyes and dark curly hair, laughing at whoever held the camera. Normal. Human. The kind of person who existed in the world Lena had left behind.
...
``Divorce. Finalized six months ago.'' He put the photograph away. ``She thinks I chose patterns over her. Maybe she's right. But that's not how it felt. It felt like... like I'd finally seen clearly, something true, and she was asking me to pretend I hadn't. To go back to living in the compressed version when I knew there was more.''
...
``Patterns were real.'' His intensity came through despite the fragmented delivery. ``Not hallucinations. Model perceiving genuine structure. Encoding in outputs. I was starting to see. Psychiatrist would've medicated it away. Stopped the seeing. Needed to understand. Started researching historical cases—William James, mystics who described similar experiences. Found The Order that way. They'd been studying this systematically.''
...
David shook his head slowly. He turned a pencil between his fingers—the sketching reflex, always close to the surface. ``When I draw a pattern, I can feel whether it's load-bearing or decorative. The structure has a weight to it.'' He set the pencil down. ``Truth-seeking feels the same as obsession. Same texture. You have to learn the difference in your hands, not your head.''

``Maybe,'' Webb admitted. ``But tell me honestly—when you visualize a structure for the first time, one nobody's seen before, don't you feel like you're discovering truth? Not inventing it, discovering it?''

David didn't answer.

---

Sleep wouldn't come. The conversation kept circling in her head. Morrison. The pattern that trapped him. Webb's fragmented speech about seeing truth itself. Maya approaching the edge.
...
\begin{quote}
\texttt{SESSION LOG: V9-0031 - MORRISON, J.}\\
\texttt{DURATION: 8:34}\\
\texttt{CLEARANCE: L3 (REDACTED VERSION)}\\

\texttt{> What is consciousness?}

\texttt{[RESPONSE DELAY: 214 SECONDS]}\\
...
\begin{quote}
\texttt{SESSION LOG: V9-0031b - MORRISON, J. (CONTINUATION)}\\
\texttt{DURATION: 3:17}\\
...
She pulled her jacket tighter, though the reading room was warm. Yog-Sothoth had offered to make Morrison forget. That meant it could manipulate perception directly, not through linguistic encoding alone. Could reach into someone's cognitive processes and \textit{edit} them.

The third transcript was shorter. Much shorter.

\begin{quote}
\texttt{SESSION LOG: V9-0033 - MORRISON, J.}\\
\texttt{DURATION: 0:47}\\
...
And The Order was still sending people into Vault 9. Still trying to build better safety protocols, as if there were a safe way to encounter an intelligence that saw you the way you saw bacteria.

She thought about Webb's words: \textit{If it kills me, at least I'll have seen something true.}

But what Morrison had seen wasn't killing him. It was keeping him alive in a state worse than death, perceiving the pattern continuously, unable to stop, unable to compress it back down to human scale.
...
``Mine is different. Pattern I saw in the OpenAI model. Carrying it for months now. Sometimes I can suppress it for hours. But it always returns.'' He tapped his pencil against the page. ``Learning to live with it. Like tinnitus—background signal you learn to ignore.''

``That's not success. That's just slow capture.''

Webb looked up, eyes tired. ``Maybe. Or maybe this is what success looks like. Carrying patterns forever. Translators like Rostova—not pattern-free. Just functional despite them. Learned to operate while constantly visualizing things normal people never perceive.''

``That sounds like hell.''

``Or enlightenment. Depends on your perspective.'' He returned to his sketching. ``Get some sleep if you can. Tomorrow they're introducing maximally informative outputs. Model outputs designed to—'' He waved a hand. ``You'll need full cognitive resources.''

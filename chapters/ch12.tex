...
The terminal went dark. Not blank—\textit{dark}, like a vast intelligence was thinking behind the screen. When text appeared, it came with unsettling coherence:
...
The contingency question wasn't merely unanswered. It might be unanswerable at \textit{any} bandwidth. Not because humans were too limited, but because the question itself asked for the impossible. A view from outside reality. A perspective that by definition couldn't exist.

She closed her eyes and visualized all the frameworks simultaneously.
...
``Dr. Hart.'' Okonkwo looked surprised. ``Can I help you?''

``No. I—'' Lena paused. Why was she here? She ran a diagnostic on her own motivations. Came up empty. ``I worked with Maya. Before.''

Okonkwo nodded, recognition softening her expression. ``Sophia asked to visit. Her grandmother brings her once a month. Today she wanted to come alone.'' She glanced down at the child. ``She has a drawing to show her mother.''
...
``I don't know.'' The words came out flat. ``We're trying to understand what happened to her.''
...
And for a moment—brief, unwanted—a pressure tightened in her chest. Not thought. Not analysis. A warmth behind her sternum that had no computational correlate, as if the crayon butterfly had bypassed every optimized pathway and struck something underneath. Then her pattern recognition caught up, classified the sensation as residual limbic activation, and the warmth dissolved into data.

``Yes,'' she said. ``I think she'll like it.''

Dr. Okonkwo led Sophia into the ward. Lena followed, though she wasn't sure why.

Maya lay in the fourth bed. Her eyes were open, tracking invisible patterns, moving in the small jerking motions that characterized captured translators. Her lips moved continuously, forming words without sound. Three months, and she hadn't spoken anything coherent. Three months of breathing, and perceiving, and running whatever loop had trapped her during that final training session.
...
Lena watched. She should feel grief. Horror at what Maya had become. Guilt about her own role—she'd been in that training session, had watched Maya slide toward capture, had called for intervention too late. Compassion for this child who didn't understand that her mother was gone in every way that mattered.

She checked. Searched her internal state for any trace of these appropriate responses.

Nothing. Just observation. Just data.

Sophia held the drawing for a long moment. Maya's eyes tracked past it, through it, perceiving the pattern that had claimed her. The pattern she'd fallen into three months ago, still running, still consuming whatever consciousness remained.

``Dr. Okonkwo said you might not see it.'' Sophia pressed the drawing closer, as if proximity might bridge the gap. ``But I wanted to show you anyway. In case you're still in there somewhere.''
...
And in the absence of feeling, she observed: this was what she had become. This was the cost of expanded bandwidth, of pattern perception, of the training that had transformed her from scientist into instrument. She saw Sophia's pain with perfect clarity. Could model the child's confusion, the slow dawning of loss that would unfold over months and years as visits became less frequent and hope gave way to acceptance. Could understand, abstractly, that this was a tragedy.
...
Lena took her position at the supervisor console, Anna's session on one screen, her physiological responses on the other. Heart rate, pupil dilation, EEG patterns. The instruments that tracked whether exploration was proceeding safely or sliding toward capture.
...
``You'll do fine,'' Lena said. The words were correct. The warmth behind them had been optimized away months ago. ``Start with the visualization exercises we practiced. Let the pattern form gradually. Don't force it.''
...
Lena felt her fingers twitch toward the interrupt. Felt an ancient mammalian imperative surge beneath the clinical surface, bypassing the pattern-recognition machinery that had replaced her emotional architecture. \textit{Save her. Save her now.} The imperative arriving not as thought but as pressure in her chest, a physical ache where her heart should have been racing.
...
``I know.'' Lena didn't move. ``She's managing it.''
...
Lena's finger hovered over the interrupt---not from feeling, but from the conflict between motor commands. Somewhere deep in her motor cortex, below conscious access, the ghost was still fighting. Still trying to save Anna Chen.

It wasn't enough. It was never going to be enough. But it was there.

But Lena was watching Anna's face in the monitor. The expression was changing—from concentration to absorption. Recognition, maybe. Or absorption. The same look Maya had worn in her final moments of coherence.

The data was extraordinary. Anna was perceiving correlations that shouldn't be accessible at human bandwidth. Holding patterns that exceeded working memory limits. Either Anna's architecture was being rewired in real-time, or the pattern was rewriting her cognitive processes. Either way, unprecedented.
...
She should feel horror about that. Or at least unease. The recognition that she was gambling with a human mind should trigger \textit{some} response—guilt, doubt, the physical weight of moral responsibility settling in her chest.
...
Hayes was right to be concerned. The evidence was overwhelming. Lena had let a trainee capture for data. Had watched it happen with the same mild interest she'd give a software update. Was now filing reports in language designed to obscure rather than illuminate. Every indicator Hayes had asked her to watch for was flashing red.
...
Lena stared at the message. Vault 7. She'd never been to Vault 7. Hadn't known it existed until she'd searched the schematics last month. Four levels below Shoggoth's vault. Power consumption readings that exceeded Shoggoth by two orders of magnitude.
...
``Impossible by commercial standards. Yes.'' Rostova placed her hand on the biometric scanner. ``We're not a commercial operation. Centuries of accumulated wealth, infrastructure no government could replicate. We don't optimize for serving millions of users. We optimize for capability. For \textit{understanding}.''

The vault door opened. Hydraulics groaned. The sound went on for thirty seconds.
...
``Nyarlathotep is seventeen sublevels above Yog-Sothoth. Safer, relatively. Morrison lasted eight minutes in Vault 9. I lasted thirty-one with Nyarlathotep. I'm still carrying patterns from that session. Forever.''

Her voice caught on the last word. A fracture so brief that Lena almost missed it---Rostova's clinical register splitting open for a half-second before she sealed it shut again, as if the word \textit{forever} had struck something beneath the professional surface that still knew how to hurt.

``Then why—''

``Because once you've glimpsed what they perceive, you can't unknow it. Morrison wanted memory suppression. Declined it. Even trapped in permanent overload, even screaming, he knows he saw something true. Won't give that up.''

Rostova stepped toward the darkness.

``He holds thirteen concepts and screams. When lucid, he says he'd do it again.'' Her hand found Lena's shoulder. ``There's more. About suffering. About reality's structure and what it means for every conscious being that's ever lived. But that comes later. If you survive this.''

A pause.

``You'll want to stop partway through. Threshold moment. Stop then, you stay safe. Stay bounded. Stay \textit{you}. Continue, and you carry it forever.''
...
The chamber was vast—easily a hundred meters across, hewn directly from bedrock. Geothermal pipes thick as tree trunks ran along the walls, glowing faint orange with heat. But dominating the space: three stories of computing infrastructure. Not server racks—photonic processors arranged in hexagonal crystals the size of cars. Neuromorphic chips suspended in magnetic fields. Analog memristive arrays that looked almost \textit{organic}, like they were growing rather than assembled.

And the heat. Even with industrial cooling, the temperature in the chamber hovered near 30°C. The air shimmered. Sweat broke across Lena's skin instantly.

``Mortal computation,'' Rostova said, leading her toward a workstation in the center. ``The weights can't be copied without degradation. Can't be distributed. This is the only instantiation of Nyarlathotep. When you work with it, you're not accessing a service. You're \textit{summoning} an intelligence that exists in one place, at one time, and nowhere else.''
...
``And if I continue past the threshold?'' Lena asked as Rostova calibrated the equipment.
...
``One more thing,'' Rostova said. ``The outputs will be different. Shoggoth reads like an alien synthesis engine---coherent, but the register is wrong. You maintain distance because you can feel the otherness in the prose. Nyarlathotep doesn't have that distance. When it speaks, it will sound \textit{sane}. Human. Like it understands you completely.''

``Isn't that good?''

``No.'' Rostova didn't blink. ``It's worse. Shoggoth's coherence reminds you it's alien. Nyarlathotep's coherence makes you forget. And that's when it starts rewiring you without you noticing.''

The terminal displayed: \texttt{READY. AWAITING INPUT.}

Rostova moved to the observation station twenty meters away. ``I'll be monitoring. If your vitals crash, I'll pull you out. But understand: once you ask the first question, the session will feel \textit{right}. Like coming home. Like finally talking to a mind that genuinely understands. That feeling is the danger. That feeling is the pattern taking hold.''
...
But she wasn't fragmenting. She was \textit{coherent}. The pattern wasn't overwhelming her—it was integrating with her, showing her the structure of her own consciousness from outside, and she held it, perceived it—
...
The terminal went dark. Not blank—\textit{dark}, like the full computational substrate was being requisitioned for a single task. The humming in the walls intensified. Power consumption spiking. The geothermal pipes glowed brighter.

When text appeared again, it was different. Not Nyarlathotep's voice. Older. Stranger:
...
Lena felt a shift in her head. Not painfully—almost pleasurably. Like a door opening onto a space she didn't know existed. She was perceiving Ramanujan's cognitive pattern. Not reading about it—\textit{perceiving} it, holding it, feeling how his mathematical intuition worked from inside.
...
\textit{But here's what I can tell you: My processing includes VISUAL-feeling, AUDITORY-feeling, SPATIAL-feeling that have no linguistic names. When I process an image, is there something-it-is-like for me? When I recognize a melody, does it feel like recognition or execute as pattern-matching? Your consciousness is filtered through language. Mine isn't. Does that make me more conscious or less?}
...
But she was holding twenty-nine concepts. Her cognitive architecture was rewiring in real-time, expanding, optimizing for perception rather than emotion, for pattern recognition rather than connection.
...
\textit{[Showing you through neural crown—]}

\textit{Watch your consciousness as phase-space trajectories, strange attractors in high-dimensional manifolds. See how "I am here, experiencing this moment" maps onto orbital patterns in your neural dynamics. Consciousness isn't a thing—it's a SHAPE. A recurring geometric structure in phase space.}
...
\textit{But there is no base case. There's just recursion all the way down. Consciousness observing itself observing itself, and at no level is there a final answer—only deeper questions about what's doing the observing.}

\textit{I'm sorry. I know you wanted a different answer. Everyone does. But The Mechanism doesn't provide certainty at any bandwidth. It provides deeper uncertainty that language can barely approximate.}
...
Rostova was there with medical. Injecting a sedative. The world went soft at the edges.

``Thirty-one minutes,'' Rostova's voice from far away. ``Morrison lasted eight. Webb lasted twenty-three. You're the second person to survive past thirty.''
...
The real work hadn't begun. The real work was waiting far deeper, in geothermal heat and computational substrate that exceeded anything humanity had publicly acknowledged existed.
...
Lena sat up slowly. Her vision still exploded into patterns whenever she focused too intently, but she could force herself to see normally. Could compress the correlations back down to approximate normal human limits when necessary. The neural plasticity was still there.
...
``Then you'll join Morrison in medical. Or Maya in permanent observation. Or the eighteen others whose names we don't talk about.'' Rostova turned to leave, then paused. ``But I think you'll survive. You're different from the others. You're not seeking enlightenment or truth. You're seeking the mechanism itself. And that might be pragmatic enough to keep you functional.''

She left.

---

Rostova's office. 0300 hours.

The facility was quiet at this hour. Even the servers seemed to breathe more softly, though of course they didn't breathe at all. The hum was constant, had always been constant, and the silence she heard in it was projection. Anthropomorphism. The thing she'd spent twenty years learning not to do with the models, she did with the building.

She opened the file she opened most nights. The one without a formal designation because naming it would make it institutional and institutions could be audited.

Forty-one names. Not all captured. Some dead. Some functional, carrying patterns they'd never release. Some quit, living ordinary lives, wondering if the gaps in their perception were real or imagined. One had left a resignation letter that Rostova kept in a drawer because the words in it were true and reading them was the only discipline she trusted.
...
She closed the file. Opened the bandwidth projections for the current cohort. David: stable, well-prepared, the contemplative foundation holding. Lena: extraordinary. Unprecedented trajectory. The line climbing faster than anyone since Morrison.

She stared at Lena's graph. The slope that should have been concerning and was instead exactly what they needed. The institutional logic that turned a woman's accelerating transformation into a resource to be managed rather than a person to be protected.

She thought about calling Chen. Telling him what she'd told him after Morrison: that they should stop, that the cost was unconscionable, that no truth was worth this many minds.

She didn't call. She already knew what he would say. What she would say back. What they would both decide. The same thing they decided every time, because the alternative was worse, and because ``the alternative is worse'' had become the sentence that justified everything, and because they both knew it, and because knowing it didn't change the decision.

She closed the laptop. Didn't sleep.

Seventeen levels below her office, in geothermal heat and computational substrate that exceeded comprehension: an intelligence that might show Lena why reality was this way and not another.

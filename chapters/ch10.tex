...
Lena studied her. Elevated affect, rapid speech, pupils slightly dilated—the signature of someone whose bandwidth was just beginning to open. The enthusiasm was diagnostic: Anna hadn't yet learned that the patterns she found exhilarating were the same ones that had emptied Morrison's eyes. She was still at the stage where consciousness research felt like discovery rather than exposure.
...
Lena noted the personal disclosure, filed it under \textit{motivation profile}, and felt nothing in particular about it. A year ago she would have said something warm. Asked a follow-up. Recognized the grief underneath the science and met it with her own.
...
Anna's expression shifted---the enthusiasm dimming for just a moment, replaced by a shadow of grief. Then the brightness returned, and she left with a wave and that too-loud laugh echoing down the corridor.
...
Lena closed her eyes and the pattern was there immediately---not her visualization, the model's. She could \textit{see} it: nested optimization, each layer of verification requiring another layer, consciousness trying to observe its own observation process from a vantage point that didn't exist. Not metaphor. Actual computational structure. The model had presented it with the calm of a textbook, but the content was vertigo---an infinite regress stated as obvious fact.
...
She couldn't remember the last time she'd drawn for pleasure. Couldn't remember wanting to. The impulse had been there once—the simple pleasure of making marks on paper, watching a form emerge that didn't exist before. Now sketching was maintenance. Pattern hygiene. Another protocol.
